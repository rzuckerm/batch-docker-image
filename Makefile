BATCH_VERSION := $(shell cat BATCH_VERSION)
BATCH_DEPS := $(wildcard BATCH_*)
DOCKER_TAG_PREFIX := rzuckerm/batch:$(BATCH_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(BATCH_DEPS)
